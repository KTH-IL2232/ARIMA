-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\HDLAWGNGenerator\Sine_HDL_Optimized2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Sine_HDL_Optimized2
-- Source Path: HDLAWGNGenerator/AWGNGenerator/GaussianNoiseWithUnitVar/SinCos/Sine HDL Optimized2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Sine_HDL_Optimized2 IS
  ...
  SIGNAL Look_Up_Table_k                  : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  ...
  LTEp50_1_cast <= insig_out1 & '0' & '0' & '0' & '0';
  ...
  Look_Up_Table_k <= to_unsigned(16#000#, 10) WHEN Switch_out1 = to_unsigned(16#000#, 12) ELSE
